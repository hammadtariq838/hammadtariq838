...
const projects = [
  {
    ...
    image: "/findyourtutor.png?height=300&width=400",
    technologies: ["NextJS 14", "React", "TypeScript", "TailwindCSS", "PostgreSQL", "AWS"],
    liveLink: "https://findyourtutor.co.uk/",
    githubLink: "https://github.com/Yousuf24100286/findyourtutor"
  },
  {
    ...
    image: "/bidai.png?height=300&width=400",
    technologies: ["React", "Express.js", "MongoDB", "Tailwind CSS", "Shadcn"],
    liveLink: "https://bidai.strux.ai/",
    githubLink: "https://github.com/hammadtariq838/BidAI"
  },
  {
    ...
    image: "/building-inspection.png?height=300&width=400",
    technologies: ["Python", "Django", "React", "OpenCV", "Docker"],
    liveLink: "https://building-inspection.hammadtariq.me/",
    githubLink: "https://github.com/hammadtariq838/Building-Inspection"
  },
  {
    ...
    image: "/smart-meet.png?height=300&width=400",
    technologies: ["Express.js", "React", "WebRTC", "Socket.io"],
    liveLink: "#",
    githubLink: "https://github.com/hammadtariq838/Smart-Meet"
  }
]
